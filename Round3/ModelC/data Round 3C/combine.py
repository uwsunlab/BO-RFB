...
# %%
path = '/Users/ctuwsunlab/Documents/Sun_Lab/PNNL/PNNL_Iteration3/Round 3C/'
...
for i in range(num_columns // 2):
    new_columns.append(f'X{i+33}')
    new_columns.append(f'Y{i+33}')

# If there are an odd number of columns, add the last one as 'X' with the next index
if num_columns % 2 != 0:
    new_columns.append(f'X{num_columns // 2 + 33}')
...
output_path = os.path.join(path, '3B_combined.csv')
